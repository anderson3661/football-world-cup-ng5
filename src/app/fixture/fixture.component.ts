...
import { TeamsModel, FixtureModel, SetOfFixturesControllerModel, TableModel, TablesModel } from '../zzz-other/interfaces/interfaces';
...
export class FixtureComponent implements OnInit {
    ...
    @Input() setOfFixturesController: SetOfFixturesControllerModel;
    ...
    private isFirstHalf = true;
    private isExtraTime = false;
    private hasFixtureFinished = false;
